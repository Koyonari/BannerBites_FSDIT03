...
const Sidebar = ({ showHelp }) => {
  ...
  return (
    <div className="flex w-3/5 flex-row items-center justify-center border-none bg-transparent py-4 text-lg shadow-none dark:secondary-text lg:fixed lg:left-4 lg:top-[52vh] lg:h-auto lg:w-24 lg:-translate-y-1/2 lg:flex-col lg:items-start lg:pl-4 xl:pl-8 xl:text-xl 2xl:top-[49vh] 2xl:text-2xl 4xl:text-4xl">
